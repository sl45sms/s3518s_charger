#!/bin/bash
# set the port where your board is connected (probably something like /dev/cu.usbserial-xxxx,adapt as needed)
PORT=$(ls /dev/cu.* | grep usbserial | head -n 1)
# set the correct fqbn for your board, here is for esp32c6
